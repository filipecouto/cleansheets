	...
	public void actionPerformed(ActionEvent e) {
		if (ipDialog == null) {
			...
			ipDialog.setOnIpSelectedListener(new OnIPSelectListener() {
				@Override
				public void onIPSelected(String address, String shareName,
						String username, int port, String password) {
					ClientInfo client = null;
					// String ip = "";
					// try {
					try {
						client = extension.createClient(new ClientInfo(shareName,
								username, password), address, port, uiController);
					} catch (Exception e) {
