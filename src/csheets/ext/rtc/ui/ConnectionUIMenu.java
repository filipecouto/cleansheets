...
public class ConnectionUIMenu extends JMenu {
    ...
    public ConnectionUIMenu(RealTimeCollaboration extension, UIController uiController) {
	super("Real Time Collaboration");
	
	shareMenuItem = new JMenuItem(new ShareAction(extension, uiController));
	add(shareMenuItem);
	
	connectMenuItem = new JMenuItem(new ConnectAction(extension, uiController));
	add(connectMenuItem);
    }
